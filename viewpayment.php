...
<strong>View The Registered payments!!</strong>
</div> 
...
<div class="table-responsive"><!--this is used for responsive display in mobile and other devices-->  
    ...
    <table class="table table-bordered table-hover table-striped">  
        ...
        <?php  
        include("config.php");  
        $view_users_query="select * from payment";//select query for viewing users.  
...
<!--here showing results in the table -->  
            ...
            <td><?php echo $dop;  ?></td>  
            <td><?php echo $due;  ?></td>  
			<td><a href="editpayment.php?edit=<?php echo $row['payment_id'] ?>"><button class="btn btn-info" onClick = 'return comfirmEdit();'>Edit</button></a></td>	
            <td><a href="deletepayment.php?del=<?php echo $idpayment ?>"><button class="btn btn-danger" onClick = 'return confirmDelete();'>Delete</button></a></td> <!--btn btn-danger is a bootstrap button to show danger-->  
        </tr>  
