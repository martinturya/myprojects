...
<strong>View The Registered Tenants!!</strong>
</div> 
...
<div class="table-responsive"><!--this is used for responsive display in mobile and other devices-->  
    ...
    <table class="table table-bordered table-hover table-striped">  
        ...
        <?php  
        include("config.php");  
        $view_users_query="select * from tenant";//select query for viewing users.  
...
<!--here showing results in the table -->  
			...
			<td><a href="edittenant.php?edit=<?php echo $row['tenant_ID'] ?>"><button class="btn btn-info" onClick = 'return comfirmEdit();'>Edit</button></a></td>	
            <td><a href="deletetenant.php?del=<?php echo $idtenant ?>"><button class="btn btn-danger" onClick = 'return confirmDelete();'>Delete</button></a></td> <!--btn btn-danger is a bootstrap button to show danger-->  
        </tr>  
