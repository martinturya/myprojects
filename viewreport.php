...
<strong>View Your Reports Now!!</strong>
</div> 
    ...
    <table class="table table-bordered table-hover table-striped">  
        ...
        <tr class="info">  
            ...
            <th id="tabhead">Last Name</th>
             <th id="tabhead">Sex</th>  
            <th id="tabhead">Phone Number</th> 			
            <th id="tabhead">District Of Origin</th>  			
            <th id="tabhead">House Location</th>  
            <th id="tabhead">Street Number</th>  
            <th id="tabhead">plot Number</th> 
            <th id="tabhead">Ammount</th>  
            <th id="tabhead">Date of payment</th>  
            <th id="tabhead">Next Payment Date </th>  			
        </tr>  
        </thead>  
  
        <?php  
        include("config.php");  
        $view_users_query="select t.tenant_ID,t.first_name,t.last_name,t.sex,t.phone_no,t.address,h.location,h.street_name,h.plot_number,p.amount,p.date_of_payment,p.due_date from tenant t,house h,payment p WHERE t.house_id=h.house_id AND t.tenant_ID=p.tenant_ID";//select query for viewing users.  
...
<!--here showing results in the table -->  
            <td><?php echo $idtenant;  ?></td>  
            <td><?php echo "<a href=receipt.php?employee=".$row['tenant_ID'].">".$row['first_name']."</a> "; ?></td>  
