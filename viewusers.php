...
<strong>View The Registered Users!!</strong>
</div> 
...
<div class="table-responsive"><!--this is used for responsive display in mobile and other devices-->  
    ...
    <table class="table table-bordered table-hover table-striped">  
        ...
        <tr class="info">  
            ...
            <th id="tabhead">Title</th>  
            <th id="tabhead">Username</th> 
...
<!--here showing results in the table -->  
			...
			<td><a href="useredit.php?edit=<?php echo $row['users_id'] ?>"><button class="btn btn-info" onClick = 'return comfirmEdit();'>Edit</button></a></td>	
            <td><a href="delete.php?del=<?php echo $iduser ?>"><button class="btn btn-danger" onClick = 'return confirmDelete();'>Delete</button></a></td> <!--btn btn-danger is a bootstrap button to show danger-->  
        </tr>  
