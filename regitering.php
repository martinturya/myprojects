...
<strong>Hello Administrator, Register The Users From here!!</strong>
</div>
<!-- Form Code Start -->
<div id='fg_membersite'>
<br><br><br><br>
<form id='register' action="regitering.php" method='post' accept-charset='UTF-8'>
<fieldset >
<table>
...
<tr><td>
    ...
    <input type='value' name='sn' id='sn' value="" maxlength="50" />
...
$sql=mysql_query("INSERT into users(first_name,lastname,user_type,user_name,password) VALUES('$fname','$lname','$st','$sn','$password')");
if($sql){
echo"<font color='blue'<br>User successfully Registered!!!!!!!!!";
}
                             else{
